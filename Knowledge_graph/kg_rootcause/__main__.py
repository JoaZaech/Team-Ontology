...
def main():
    ...
    parser.add_argument("--data", type=Path, default=root / "viseca-2026/data")
    parser.add_argument("--output", type=Path, default=root / "Knowledge_graph/build")
    ...
    write_json(args.output / "precomputed_evidence.json", precompute_summaries(dataset))
